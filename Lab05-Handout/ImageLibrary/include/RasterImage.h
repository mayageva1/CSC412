...
/**	Assigns a new raster to an image.  Frees the original
 *	raster if it had been allocated.  This ius exactly the type of function that screams
 *  to be a private instance function in an OOP implementation.  Here, it cannot verify
 *	whether the new raster is actually properly allocated, at the correct dimensions.
