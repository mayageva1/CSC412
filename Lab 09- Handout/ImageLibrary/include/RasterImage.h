...
/**	This is the data type to store all relevant information about an image.  This is 
 *	really just a storage class with no constructor, destructor, or other instance
 *	functions.  So, just a very superficial C++ brush-up on top of the C base.
 */
