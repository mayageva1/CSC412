#!/usr/bin/env bash
# Usage: bash Scripts/script05.sh [-t] <watch_folder> <output_folder>
# NOTE: -t is accepted for position but ignored here; tracing is decided by task files/program.
...
# ---- run prog05v4 and feed via FIFO (macOS/Bash 3.2 safe) ----
